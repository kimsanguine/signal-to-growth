...
This repository contains one portable Agent Skills source tree with thin adapters for Codex and Claude Code. Preserve artifact contracts, human approval boundaries, and cross-runtime behavior.
