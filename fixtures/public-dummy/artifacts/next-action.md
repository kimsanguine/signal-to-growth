...
- **왜 이게 다음인가**: `DEC-20260725-001`의 review_at(`2026-08-08`)이 지났고, 같은 날짜에 기록된 `OUT-20260725-001`은 `conclusion: hold`(cohort 미성숙, `sample_size: 0`)다. 기존 decision을 고쳐 쓸 수 없으므로, 새 review_at을 설정하는 후속 decision을 append해야 다음 사이클이 시작된다.
